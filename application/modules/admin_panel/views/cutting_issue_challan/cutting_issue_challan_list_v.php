...
<html lang="en">
<head>
    <title>Cutting Issue Challan List | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Cutting Issue Challan</h3>
                        ...
                        <div class="panel-body">
                            <?php 
                                if($view_permission != 'block'){
                                    ?>
                            <a href="<?= base_url('admin/add-cutting-issue-challan') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Cutting Issue Challan</a>
                            <br><br>
                                <?php
                            } 
                            ?>
...
<script>
    $(document).ready(function() {
        $('#cutting_issue_challan_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-cutting-issue-challan-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
            ...
            "columnDefs": [{
                "targets": [7,8], //disable 'Image','Actions' column sorting
                "orderable": false,
            }]
        } );
    } );
