...
<html lang="en">
<head>
    <title>Edit Sample Bill | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1000px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Edit Sample Bill</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Edit Sample Bill </li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-8">
                    <section class="panel">
                        <header class="panel-heading">
                            Edit: <?= $sample_bill_detail[0]->sample_bill_number ?>
                        ...
                        <?php #print_r($purchase_order_details); die;?>
                            <form id="form_edit_sample_bill" method="post" action="<?=base_url('admin/form-edit-sample-bill')?>" class="cmxform form-horizontal tasi-form">
                            <div class="form-group ">
                            	<div class="col-lg-4">
                                    <label for="am_id" class="control-label text-danger">Select sample*</label>
                                    <select id="am_id" name="am_id" class="form-control select2">
                                        <option value="">Select sample</option>
                                        <?php foreach($sample_details as $sample){?>
                                        <option value="<?=$sample->am_id?>" <?php if($sample_bill_detail[0]->am_id == $sample->am_id){?> selected <?php } ?>><?=$sample->name?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-lg-4">
                                	<label for="sample_bill_number" class="control-label text-danger">sample Bill Number *</label>
                                	<input id="sample_bill_number" name="sample_bill_number" value="<?= $sample_bill_detail[0]->sample_bill_number ?>" type="text" placeholder="sample Bill Number" class="form-control round-input" />
                                </div>
                                <div class="col-lg-4">
                                    <label for="sample_bill_date" class="control-label text-danger">sample Bill Date *</label>
                                    <input id="sample_bill_date" name="sample_bill_date" value="<?= date('Y-m-d', strtotime($sample_bill_detail[0]->sample_bill_date)) ?>" type="date" placeholder="sample Bill Date" class="form-control round-input" />
                                </div>
                            </div>
                            <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-3">
                                        <button class="btn btn-success" type="submit"><i class="fa fa-refresh"> Update sample Bill</i></button>
                                    </div>
                                    
                                </div> 
                                <input type="hidden" id="sample_bill_id" name="sample_bill_id" class="hidden" value="<?= $sample_bill_detail[0]->sample_bill_id ?>" />
                            </form>
                        </div>
                    </section>
                </div>
                <div class="col-md-4 hidden-xs">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                        <form id="form_sample_bill_net_amount" method="post" action="<?=base_url('admin/form-sample-bill-net_amount')?>" class="cmxform form-horizontal tasi-form">
                            <div class="col-lg-6">
                                <label for="total_quantity" class="control-label">Article Quantity *</label>
                                <input id="article_quantity" name="article_quantity" type="text" placeholder="Article Quantity" class="form-control" value="<?= $sample_bill_detail[0]->article_quantity ?>" readonly />
                            </div>
                            <div class="col-lg-6">
                                <label for="article_total" class="control-label">Article Total *</label>
                                <input id="article_total" name="article_total" type="text" placeholder="Value" class="form-control" value="<?= $sample_bill_detail[0]->article_total ?>" readonly/>
                            </div>
                            
                            <div class="col-lg-6">
                                <label for="bill_amount" class="control-label">Bill Amount*</label>
                                <input id="bill_amount" name="bill_amount" type="text" placeholder="Bill Amount" class="form-control" value="<?= $sample_bill_detail[0]->article_total ?>" readonly/>
                            </div>
                            <div class="col-lg-6">
                                <label for="deduction" class="control-label">Deduction*</label>
                                <input id="deduction" name="deduction" type="text" placeholder="Deduction" class="form-control" value="<?= $sample_bill_detail[0]->deduction ?>"/>
                            </div>
                            
                            <div class="col-lg-6">
                                <label for="addition" class="control-label">Addition*</label>
                                <input id="addition" name="addition" type="text" placeholder="Addition" class="form-control" value="<?= $sample_bill_detail[0]->addition ?>" />
                            </div>
                            <div class="col-lg-6">
                                <label for="net_bill" class="control-label">Net Bill Amount*</label>
                                <input id="net_bill" name="net_bill" type="text" placeholder="Net Bill Amount" class="form-control" value="<?= $sample_bill_detail[0]->net_bill ?>" readonly/>
                            </div>                            
                            <div class="col-lg-6">
                                <div class="col-sm-offset-3 col-sm-3">
                            ...
                            <input type="hidden" id="hidden_sample_bill_id" name="hidden_sample_bill_id" class="hidden" value="<?= $sample_bill_detail[0]->sample_bill_id ?>" />
            ...
            <div class="row">
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Add sample Bill details for: <?= $sample_bill_detail[0]->sample_bill_number ?>
                            <span class="tools pull-right">
                                <a class="t-collapse fa fa-chevron-down" href="javascript:;"></a>
                            </span>
                        </header>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="cut_issue_challan_list" class="tab-pane fade in active">
                                    <table id="office_proforma_details_table" class="table data-table dataTable">
                                        <thead>
                                            <tr>
                                                <th>sample Receipt Number</th>
                                                <th>sample Issue Challan Number</th>
                                                <th>Article Id</th>
                                                <th>Leather Color</th>
                                                <th>Fitting Color</th>
                                                <th>Quantity</th>
                                ...
                                <div id="cut_issue_challan_add" class="tab-pane fade">
                                    <br/>
                                    <div class="form">
                                        <form id="form_add_sample_bill_details" method="post" action="<?=base_url('admin/form-add-sample-bill-details')?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group ">
                                            	<div class="col-lg-4">
                                                    <label for="sample_challan_receipt_id" class="control-label text-danger">Select sample Rcpt.*</label>
                                                    <select id="sample_challan_receipt_id" name="sample_challan_receipt_id" class="form-control select2">
                                                        <option value="">Select sample Rcpt.</option>
														<?php
                                                        foreach($sample_challan_receipt as $jcr){
                                                        ?> 
                                                        <option value="<?= $jcr->sample_challan_receipt_id ?>"><?=$jcr->sample_receipt_challan_number?></option>
                                                        <?php
                                                        }
                                                        ?>
                                                     </select>
                                                ...
                                                <!--<div class="col-lg-4">
                                                    <label for="sample_bill_remarks" class="control-label">Remarks</label>
                                                    <input id="sample_bill_remarks" name="sample_bill_remarks" type="text" placeholder="Remarks" class="form-control" value=""/>
                                                </div>-->
                                            </div>
                                            ...
                                            <input type="text" name="sample_bill_id" id="sample_bill_id" class="hidden" value="<?= $sample_bill_detail[0]->sample_bill_id ?>" />
                                        </form>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#office_proforma_details_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-sample-bill-detail-table-data')?>",
                "type": "POST",
                "dataType": "json",
                data: {
                    sample_bill_id: function () {
                        return $("#sample_bill_id").val();
                    },
                },
            },
            //will get these values from JSON 'data' variable
            "columns": [
                { "data": "sample_receipt_number" },
                { "data": "sample_issue_challan_number" },
				{ "data": "article_id" },
                { "data": "leather_color" },
				{ "data": "fitting_color" },
                { "data": "quantity" },
...
// all items-on-item-group -> from Transaction controller 
	...
	$("#sample_challan_receipt_id").change(function(){
		$sample_challan_receipt_id = $('#sample_challan_receipt_id').val();
		var table = '';
			table += '<table id="co_dtl_tbl_view" class="table">';
				table += '<tr>';
					table += '<th>sample Receipt Number</th>';
					table += '<th>sample Issue Challan Number</th>';
			...
			$.ajax({
				url: "<?= base_url('admin/sample-bill-get-customer-order-dtl') ?>",
				method: "post",
				dataType: 'json',
				data: {'sample_challan_receipt_id': $sample_challan_receipt_id},
				success: function(all_orders){
					if(all_orders.length == 0){
						...
						for(var i = 0; i < $ordersArray.length; i++){
							...
							new_rows += '<tr>';
								new_rows += '<td>'+$ordersArray[i].sample_receipt_challan_number+'<input type="hidden" name="sample_challan_receipt_id[]" id="sample_challan_receipt_id'+$ordersArray[i].sample_challan_receipt_details_id+'" value="'+$ordersArray[i].sample_challan_receipt_id+'"></td>';					
								
								new_rows += '<td>'+$ordersArray[i].sample_challan_number+'<input type="hidden" name="sample_issue_id[]" id="sample_issue_id_'+$ordersArray[i].sample_challan_receipt_details_id+'" value="'+$ordersArray[i].sample_issue_id+'"></td>';
								
								new_rows += '<td>'+$ordersArray[i].art_no+'<input type="hidden" name="am_id[]" id="am_id_'+$ordersArray[i].sample_challan_receipt_details_id+'" value="'+$ordersArray[i].am_id+'"></td>';
								
								
								new_rows += '<td>'+$ordersArray[i].leather_color+'<input type="hidden" name="lc_id[]" id="lc_id_'+$ordersArray[i].sample_challan_receipt_details_id+'" value="'+$ordersArray[i].lc_id+'"></td></td>';
								
								new_rows += '<td>'+$ordersArray[i].fitting_color+'<input type="hidden" name="fc_id[]" id="fc_id_'+$ordersArray[i].sample_challan_receipt_details_id+'" value="'+$ordersArray[i].fc_id+'"></td></td>';
								
								new_rows += '<td><input type="text" class="form-control" name="quantity[]" id="quantity_'+$ordersArray[i].sample_challan_receipt_details_id+'" value="'+$ordersArray[i].sample_receive_quantity+'" onblur="updateTotalRate('+$ordersArray[i].sample_challan_receipt_details_id+')" readonly></td>';
								
								new_rows += '<td><input type="text" class="form-control" name="extra_quantity[]" id="extra_quantity_'+$ordersArray[i].sample_challan_receipt_details_id+'" value="" onblur="updateTotalRate('+$ordersArray[i].sample_challan_receipt_details_id+')"></td>';
								
								new_rows += '<td><input type="text" class="form-control" name="rate[]" id="rate_'+$ordersArray[i].sample_challan_receipt_details_id+'" value="'+$ordersArray[i].rate+'" onblur="updateTotalRate('+$ordersArray[i].sample_challan_receipt_details_id+')"></td>';
													
								new_rows += '<td><input type="text" class="form-control" name="total[]" id="total_'+$ordersArray[i].sample_challan_receipt_details_id+'" value="'+$ordersArray[i].total+'" readonly></td>';
							  new_rows += '</tr>';
						}//end for
    ...
    $("#form_edit_sample_bill").validate({
        rules: {
            am_id: {
                required: true
            },
    ...
    $('#form_edit_sample_bill').ajaxForm({
        beforeSubmit: function () {
            return $("#form_edit_sample_bill").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
    ...
    $("#form_add_sample_bill_details").validate({
        rules: {
            sample_challan_receipt_id: {
                required: true,
            }
        },
        messages: {
    ...
    $('#form_add_sample_bill_details').ajaxForm({
        beforeSubmit: function () {
            return $("#form_add_sample_bill_details").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
        success: function (returnData) {
			...
			var table = '';
			$('#co_dtl_tbl').html(table);
            $("#form_add_sample_bill_details").validate().resetForm(); //reset validation
            notification(obj);
    ...
    $('#form_edit_cutting_issue_challan_details').ajaxForm({
        ...
        success: function (returnData) {
            ...
            $('#form_add_sample_bill_details')[0].reset(); //reset form
...
// delete area 
    ...
    $(document).on('click', '.delete', function(){
        ...
        if(confirm("Are You Sure?")){
            ...
            $.ajax({
                url: "<?= base_url('admin/del-sample-bill-details-list') ?>",
                dataType: 'json',
                type: 'POST',
	...
	$("#form_sample_bill_net_amount").validate({
        rules: {
            net_bill: {
                required: true
            }
    ...
    $('#form_sample_bill_net_amount').ajaxForm({
        beforeSubmit: function () {
            return $("#form_sample_bill_net_amount").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
        success: function (returnData) {
            obj = JSON.parse(returnData);
			notification(obj);
