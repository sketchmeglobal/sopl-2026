            ...
            buttons: {
                ...
                printwithoutrate: {
                    ...
                    action: function(){
                        ...
                        window.open("<?= base_url() ?>admin/purchase-order-print-without-rate/"+ $poi, "_blank");
                ...
                customerOrderPrint: {
                    ...
                    action: function(){
                        ...
                        window.open("<?= base_url() ?>admin/purchase-order-print-with-customer-order/"+ $poi, "_blank");
