...
<html lang="en">
<head>
    <title>Add Skiving Bill | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 600px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Add Skiving Bill</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Add Skiving Bill</li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                            <form id="form_add_skiving_bill" method="post" action="<?=base_url('admin/form-add-skiving-bill')?>" class="cmxform form-horizontal tasi-form">
                            	<div class="form-group ">
                                    <div class="col-lg-4">
                                        <label for="skiving_bill_number" class="control-label text-danger">Skiving Bill Number *</label>
                                        <input id="skiving_bill_number" required name="skiving_bill_number" type="text" placeholder="Skiving Bill Number" class="form-control round-input" />
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="skiving_bill_date" class="control-label text-danger">Skiving Bill Date *</label>
                                        <input id="skiving_bill_date" required name="skiving_bill_date" type="date" placeholder="Skiving Bill Date" class="form-control round-input" />
                                    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <textarea id="skiving_bill_remark" name="skiving_bill_remark" placeholder="Remark, if any" class="form-control round-input"></textarea>
                                    </div>
                                    <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <button class="btn btn-success pull-right" type="submit"><i class="fa fa-plus"> Add Skiving Bill</i></button>
                                    </div>
                                    <!--<div class="col-lg-6">-->
...
<script>
    ...
    $("#form_add_skiving_bill").validate({
        rules: {
            skiving_bill_number: {
                required: true
            },
    ...
    $('#form_add_skiving_bill').ajaxForm({
        beforeSubmit: function () {
            return $("#form_add_skiving_bill").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
        success: function (returnData) {
			...
			if(obj.insert_id > 0){
				$('#form_add_skiving_bill')[0].reset(); //reset form
				$('#form_add_skiving_bill :radio').iCheck('update'); //reset all iCheck fields
				$("#form_add_skiving_bill").validate().resetForm(); //reset validation
				
	            window.location.href='<?=base_url()?>admin/edit-skiving-bill/'+obj.insert_id;
	            
				// $('#edit_btn').attr('href', '<?=base_url()?>admin/edit-skiving-issue-challan/'+obj.insert_id);
