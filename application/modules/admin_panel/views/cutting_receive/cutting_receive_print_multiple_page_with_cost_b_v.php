                                    ...
                                    foreach ($datam as $item) {
                                        ...
                                        if (!isset($groups[$key])) {
                                            $groups[$key] = array(
                                                ...
                                                'gr_rate' => $item->cutting_rate_b,
                                                'gr_amount' => ($item->receive_cut_quantity * $item->quantity * $item->cutting_rate_b)
                                            );
                                        } else {
                                            $groups[$key]['ord_nu'] = $item->cut_rcv_number;
                                            $groups[$key]['gr_sum'] += $item->receive_cut_quantity;
                                            $groups[$key]['gr_parts'] += $item->quantity;
                                            $groups[$key]['gr_rate'] += $item->cutting_rate_b;
                                            $groups[$key]['gr_amount'] += ($item->receive_cut_quantity * $item->quantity * $item->cutting_rate_b);
                                        }
                                    }
                                ...
                                <tbody>
                                   ...
                                   <?php }
                                    ...
                                    <tr>
                                        ...
                                        $total_parts += $d->quantity; 
                                        echo $d->quantity;
                                        $grand_total_parts += $d->quantity;
                                        ?></td>
                                        <td class="text-right"><?php
                                        $total_rate += $d->cutting_rate_b;
                                        echo $d->cutting_rate_b;
                                        $grand_total_rate += $d->cutting_rate_b;
                                        ?></td>
                                        <td class="text-right">
                                            <?php
                                            $total = $d->receive_cut_quantity * $d->quantity * $d->cutting_rate_b;
                                            $total_amount = $total;
                                            echo $total;
