                    ...
                    <section class="panel">
                        ...
                        <?php #print_r($purchase_order_details); die;?>
                            ...
                            <div class="col-lg-2">
                                                    ...
                                                    <input type="number" id="extra_time" name="extra_time" value="<?= $checking_details[0]->extra_time ?>" class="form-control" />
                                                </div>
                            </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="cut_issue_challan_add" class="tab-pane fade">
                                    ...
                                    <div class="form">
                                        <form id="form_add_checking_list_details" method="post" action="<?=base_url('admin/form-add-checking-listn-details')?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group ">
                                                ...
                                                <div class="col-lg-2">
                                                    <label for="remarks_for_other_quantity" class="control-label text-danger">Checking Type</label>
                                                    <select id="remarks_for_other_quantity" name="remarks_for_other_quantity" class="form-control select2">
                                                        <option value="CHECKING">CHECKING</option>
                                                        <option value="OTHERS">OTHERS</option>
                                                        <option value="POLY/PAPER PACKING">POLY/PAPER PACKING</option>
                                                        <option value="BOX PACKING">BOX PACKING</option>
                                                        <option value="INNER CARTON PACKING">INNER CARTON PACKING</option>
                                                        <option value="EMBOSSING">EMBOSSING</option>
                                                        <option value="PRICE LABELS">PRICE LABELS</option>
                                                        <option value="ARTICLE LABELS">ARTICLE LABELS</option>
                                                     </select>
                                                </div>
                                                <div class="col-lg-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                                    <label for="checked_alter_add" class="control-label text-danger">Checked Qunatity</label>
                                    ...
                                    <form id="form_edit_checking_list_details" method="post" action="<?=base_url('admin/form-edit-checking-list-details')?>" class="cmxform form-horizontal tasi-form">
                                        <div class="form-group ">
                                          ...
                                          <div class="col-lg-4"><!-- It is showing Article Number[Atricle Details] but calculating with the customer order detail PK -->
                                            ...
                                            <div class="col-lg-2">
                                                    <label for="remarks_for_other_quantity_edit" class="control-label text-danger">Checking Type</label>
...
// 		}
		...
		$('#checked_quantity_add').val(0);
		$('#checked_alter_add').val($remaining_checking_quantity);
		$("#checked_quantity_add").prop("readonly", true);
		$("#checked_alter_add").prop("readonly", false);
		}
    ...
    $("#checking_list_details_table").on('click', '.checking_detail_edit_btn', function() {
        ...
        $.ajax({
            ...
            success: function(data){
				...
				$("#checked_alter_edit").val($checking_detail.rejection_quantity);
				$("#remarks_for_other_quantity_edit").html("<option>"+$checking_detail.remarks_for_other_quantity+"</option>").trigger('change');
...
<script>
    $('#for_others, #for_others_edit').on('change', function() { 
    if (this.checked) {
        // alert();
        // $("#checked_alter_edit").val('0');
        // $("#checked_alter_add").val('0');
