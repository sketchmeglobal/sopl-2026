...
<html lang="en">
<head>
    <title>Checking List | <?=WEBSITE_NAME;?></title>
                        ...
                        <div class="panel-body">
                            <?php 
                                if($view_permission != 'block'){
                                    ?>
                            <a href="<?= base_url('admin/checking-list-add') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Checking List</a>
                                <?php
                            } 
                            ?>
...
<script>
    $(document).ready(function() {
        $('#cutting_receive_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-checking-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
    ...
    $(document).on('click', '.delete', function(){
        if(confirm('Are you sure?')){
            ...
            $.ajax({
                url: "<?= base_url('admin/delete-checking-list-header') ?>",
                type: 'POST',
                dataType: 'json',
