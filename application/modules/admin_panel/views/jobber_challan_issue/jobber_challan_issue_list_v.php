...
<html lang="en">
<head>
    <title>Jobber Challan Issue List | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Jobber Challan Issue</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Jobber Challan Issue </li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
                        ...
                        <div class="panel-body">
                            <?php 
                                if($view_permission != 'block'){
                                    ?>
                            <a href="<?= base_url('admin/jobber-challan-issue-add') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Jobber List</a>
                                <?php
                            } 
                            ?>
...
<script>
    $(document).ready(function() {
        $('#cutting_receive_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-jobber-challan-issue-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
