...
// echo '<pre>', print_r($jobber_issue_details), '</pre>';
//die;
$tot_qnty_q = 0;
...
<html lang="en">
    ...
    <head>
       ...
       <link href="https://fonts.googleapis.com/css?family=Chivo|Signika" rel="stylesheet">
        ...
        <style>
            ...
            .remove_charge{display: block;margin: auto;}    
            ...
            @media print{
                ...
                .border-bottom{border-bottom:  1px solid #000}
                .remove_charge{display: none;display: block;margin: auto;}
                .show_cell{display: none;}
            }
    ...
    <body class="A4" id="page-content">
        ...
        <section class="sheet padding-10mm" style="height: auto">
            <button class="remove_charge btn btn-warning">Show labour charge</button>
                            ...
                            <table class="table table-bordered table-hover width-100 table2excel" >
                                <thead>
                                    <tr>
                                        ...
                                        <th>Qnty</th>
                                        <th>Emboss</th>
                                        <th class="show_cell">L. Charge</th>  
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                            ...
                            <div class="row table-responsive">
                                <table class="table table-bordered table-hover table2excel" style="font-size: 12px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right show_cell" style="font-size: 13px;"><?= round($ppl->labour_charge, 2) ?></td>
                                    </tr>
...
//                                echo 'td to be added. =>' . $add_td;die;
        ...
        <script>
            $(".remove_charge").click(function(){
                $('.show_cell').each(function(index, tr) { 
