...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Buyer Article Print | <?=WEBSITE_NAME;?></title>
...
<div class="row border_all text-center text-uppercase mar_bot_3">
                        <h3 class="mar_0 head_font">Proforma Invoice — Buyer Article Print</h3>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row table-responsive">
                        <table class="table table-bordered table-hover table2excel">
                            ...
                            $iter++ ?>
                                    <tr>
                                        <td><?= !empty($cm->buyer_article_no) ? $cm->buyer_article_no : $cm->alt_art_no ?></td>
                                        <td><?= $cm->info ?></td>
                                        <td><?= $cm->hsncode ?></td>
...
?>
                        ...
                        <tr>
                            ...
                            <td style="text-align:left;"><h6 class="">Volume Weight: Kgs</h6></td>
