...
<html lang="en">
<head>
    <title>Office Proforma List | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Office Proforma</h3>
                        ...
                        <div class="panel-body">
                            <?php 
                                if($view_permission != 'block'){
                                    ?>
                            <a href="<?= base_url('admin/add-office-proforma') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Office Proforma</a>
                                <?php
                            } 
                            ?>
...
<script>
    $(document).ready(function() {
        $('#cutting_issue_challan_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-office-proforma-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
            ...
            "columnDefs": [{
                "targets": [2,3,7], //disable 'Image','Actions' column sorting
                "orderable": false,
            }]
        } );
    } );
