                            ...
                            <form class="row" method="post" target="_blank">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-lg-4">
                                        ...
                                        <input autocomplete="off" type="date" id="" name="fromdate" class="form-control date" required value="<?=YEAR_START_DATE?>" /><br>
                                        <label>To date</label>
                                        <?php 
                                            $month = date('m');
                                            $day = date('d');
                                    ...
                                    <div class="col-md-3 col-lg-4"> 
                                        <input type="submit" name="supplier_wise_outstanding" value="Print" class="btn btn-sm btn-success" />
                                        <!--<input type="submit" name="supplier_wise_outstanding" value="Print(w/o zero)" class="btn btn-sm btn-success" />-->
                                    </div>
                                </div>
                            </form>
                            <br/>
