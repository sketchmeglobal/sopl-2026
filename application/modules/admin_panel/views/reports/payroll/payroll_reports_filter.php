            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                                ...
                                <div class = "row">
                                    <div class="col-lg-3">
                                        ...
                                        <select id="group" name="group" class="form-control select2" required>
                                            ...
                                            <?php
                                            foreach ($data['departments'] as $fcbl) {
                                                ?>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input style="margin-top:5px" type="submit" name="reg_excel" class="btn btn-warning btn-sm" value="Register (Excel)" target="_blank" />
                        ...
                        <div class="panel-footer col-sm-4 col-lg-3 col-xl-2">
                            <a href="<?=base_url('admin/dept-employee-list?q=all')?>" class="btn btn-success" target="_blank">All Employee List</a>
                        </div>
                        <div class="panel-footer col-sm-4 col-lg-3 col-xl-2">
                            <a href="<?=base_url('admin/dept-employee-list?q=register')?>" class="btn btn-success" target="_blank">Registered Employee List</a>
                        </div>
                    </section>
                </div>
            </div>
