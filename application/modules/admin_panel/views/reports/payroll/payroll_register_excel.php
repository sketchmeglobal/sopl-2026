...
<html lang="en">
    ...
    <body class="A4 landscape" id="page-content" >
        ...
        <div class="col-sm-6 border_all header_left" style="height: 68px; text-align: left;">
        	<b>Month: <?=$data['mont'] ?><br />Date: <?=date('d-m-Y') ?><br /></b>
        </div>
        </div>
        <!--table data-->
        <div class="row">
        	...
        	<div class="row">
        		<div class="table-responsive">
        			...
        			<table border="1" id="all_det" class="table table-bordered">
        				<thead>
        <tr>
                        <th class="text-center" align="center" colspan="26">REGISTER OF WAGES (<?= $data['mont'] . ', ' . YEAR ?>) <br /> [Prescribed under Rule 23(1) of the West Bengal Minimum Wages Rules 1951] <br /> [Prescribed under Rule 26(1) of the Central Minimum Wages Rules 1951]</th>
                    </tr>
                    <tr>
