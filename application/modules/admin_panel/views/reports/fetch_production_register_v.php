...
<style>
    ...
    .jobber-report-table td {
        border: 1px solid #000;
        padding: 3px;
    }
    
    .jobber-report-table td.date {
        text-align: center;
    }
    
    .jobber-report-table td.quantity {
        text-align: right;
        padding-right: 5px;
    }
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <div class="wrapper">
            ...
            <!-- Jobber Receipt Report Section -->
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Jobber Receipt Details (BAG/SLG Department)
                        </header>
                        <div class="panel-body">
                            <!-- Date Filter Form -->
                            <form class="row" method="post" action="<?=base_url('admin/jobber-receipt-report')?>">
                                <div class="col-sm-3">
                                    <label>From Date</label>
                                    <input type="date" name="from_date" class="form-control" value="<?php echo isset($from_date) ? $from_date : date('Y-m-01'); ?>" required>
                                </div>
                                <div class="col-sm-3">
                                    <label>To Date</label>
                                    <input type="date" name="to_date" class="form-control" value="<?php echo isset($to_date) ? $to_date : date('Y-m-t'); ?>" required>
                                </div>
                                <div class="col-sm-2">
                                    <input type="submit" name="filter_jobber_receipt" value="Filter" class="btn btn-sm btn-primary" />
                                </div>
                            </form>
