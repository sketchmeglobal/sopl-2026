...
<html lang="en">
<head>
    <title>Supplier Wise Item Position<?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Report - Supplier wise item position report</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active">Supplier wise tem position Report</li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
