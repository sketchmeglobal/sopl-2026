...
<head>
    ...
    <style>
        ...
        @media print{
            ...
            .table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th {padding: 5px; text-align: left; font-size: 13px;border:1px solid;}
            ...
            <div class="row">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="A4 landscape" id="printable_area">
                                        ...
                                        <table id="all_det" class="table table-bordered order-summary" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Emp. Name</th>
                                                    <th>Date</th>
                                                    <th style="text-align:right">Normal Duty Hours</th>
                                                    <th style="text-align:right">Overtime Duty Hours</th>
                                                    ...
                                                    <th>Qnty.</th>
                                                    <th>Category</th>
                                                    <th style="text-align:right">Category Qnty.</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php 
                                                $iter = 1;
                                                $sub_total_arr = $sub_total_emp_arr = array();
                                                $qnty_total = $cat_qnty_total = $qnty_total_emp = $cat_qnty_total_emp = 0;
                                                if(isset($inking_report) and count($inking_report) > 0){ 
                                                    foreach($inking_report as $ir){
                                                        $cond_str = $ir->name.$ir->inking_entry_date;
                                                        if(!in_array($cond_str, $sub_total_arr)){
                                                            ...
                                                            <tr style="background: #dedede">
                                                                ...
                                                                <td class="qnty_total text-right"><?=$qnty_total?></td>
                                                                <td></td>
                                                                <td class="cat_qnty_total text-right"><?=$cat_qnty_total?></td>
                                                            </tr>
                                                            <?php
                                                                $qnty_total = $cat_qnty_total = 0;
                                                            }
                                                        }

                                                        $cond_str1 = $ir->name;
                                                        if(!in_array($cond_str1, $sub_total_emp_arr)){
                                                            array_push($sub_total_emp_arr, $cond_str1);
                                                            if($iter != 1){
                                                            ?>
                                                            <tr style="background: #e2edf9">
                                                                <th colspan="10">Sub Total [Employee Wise]</th>
                                                                <td class="qnty_total text-right"><?=$qnty_total_emp?></td>
                                                                <td></td>
                                                                <td class="cat_qnty_total text-right"><?=$cat_qnty_total_emp?></td>
                                                            </tr>
                                                            <?php
                                                                $qnty_total_emp = $cat_qnty_total_emp = 0;
                                                            }
                                                        }
                                                    ?>
                                                        ...
                                                        <tr>
                                                            <td><?=$iter++?></td>
                                                            <td><?=$ir->name?></td>
                                                            <td><?=date('d-m-Y', strtotime($ir->inking_entry_date)) . ' [' . date('l', strtotime($ir->inking_entry_date)) . ']'?></td>
                                                            <td style="text-align:right">
                                                                <?php 
                                                                $dd = date('l', strtotime($ir->inking_entry_date));
                                                            ...
                                                            <td style="text-align:right"><?=$et = $ir->extra_time?></td>
                                                            <td style="text-align:right"><?=$dh+$et?></td>
                                                            <td><?=$ir->co_no?></td>
                                                            <td><?=$ir->art_no?></td>
                                                            <td><?=$ir->color?></td>
                                                            ...
                                                            <td style="text-align:right">
                                                                <?php 
                                                                    if($ir->remarks_for_other_quantity == 'OTHERS') {
                                                                        echo $ir->rejection_quantity; 
                                                                        $qnty_total  += $ir->rejection_quantity;
                                                                        $qnty_total_emp += $ir->rejection_quantity;
                                                                    } else{
                                                                        echo $ir->checked_quantity; 
                                                                        $qnty_total += $ir->checked_quantity;
                                                                        $qnty_total_emp += $ir->checked_quantity;
                                                                    }   
                                                                ?>
                                                            </td>
                                                            <td><?=$ir->inking_category?></td>
                                                            <td style="text-align:right"><?php $cat_qnty_total+=$ir->category_quantity; $cat_qnty_total_emp+=$ir->category_quantity; echo $ir->category_quantity?></td>
                                                        </tr>
                                                    ...
                                                    <tr style="background: beige">
                                                        ...
                                                        <th class="qnty_total_grand text-right"><?=$qnty_total?></th>
                                                        <th></th>
                                                        <th class="cat_qnty_total_grand text-right"><?=$cat_qnty_total?></th>
                                                    </tr>
                                                    <?php
                                                }  else{
...
<script>
    ...
    $qnty_total_grand = $cat_qnty_total_grand = 0;
    $('.qnty_total').each(function(){
        $qnty_total_grand += parseInt($(this).text());
        $(".qnty_total_grand").text($qnty_total_grand)
    });
    $('.cat_qnty_total').each(function(){
        $cat_qnty_total_grand += parseInt($(this).text());
        $(".cat_qnty_total_grand").text($cat_qnty_total_grand)
    });
</script>
