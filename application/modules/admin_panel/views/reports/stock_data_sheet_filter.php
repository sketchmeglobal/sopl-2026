...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Report - Stock  Data Sheet</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Stock  Data Sheet </li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <form class="row" method="post" target="_blank">
                                ...
                                <div class="col-sm-2">
                                    <input type="submit" name="data_sheet_submit" value="Print" class="btn btn-sm btn-success col-lg-12" /> <br>
                                </div>
