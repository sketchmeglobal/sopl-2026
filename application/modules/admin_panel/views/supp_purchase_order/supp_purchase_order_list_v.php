...
<html lang="en">
<head>
    <title>Supp. Purchase Order List | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Supp Purchase Order</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Supp Purchase Order </li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
                        ...
                        <div class="panel-body">
                            <?php 
                                if($view_permission != 'block'){
                                    ?>
                            <a href="<?= base_url('admin/add-supp-purchase-order') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Supp.Purchase Order</a>
                                <?php
                            } 
                            ?>

                            <table id="supp_purchase_order_table" class="table data-table dataTable">
                                <thead>
                                    <tr>
                                        <th>Supp PO Name</th>
                                        <th>PO Number</th>
...
<script>
    $(document).ready(function() {
        $('#supp_purchase_order_table').DataTable( {
            "processing": true,
            "language": {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-supp-purchase-order-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
            ...
            "columnDefs": [{
                "targets": [1,3,5,6], //disable 'Image','Actions' column sorting
                "orderable": false,
            }]
        } );
    } );
        ...
        if(confirm('Are you sure?')){
            ...
            $.ajax({
                ...
                success: function(returnData){
                    ...
                    $('#supp_purchase_order_table').DataTable().ajax.reload();
                },
                error: function(e,v){
                    console.log(e + v);
                }
