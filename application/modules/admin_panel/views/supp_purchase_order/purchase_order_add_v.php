                            ...
                            <form id="form_add_purchase_order" method="post" action="<?=base_url('admin/form_add_purchase_order')?>" class="cmxform form-horizontal tasi-form">
                                ...
                                <div class="form-group ">
                                    <div class="col-lg-6">
                                        ...
                                        <input id="po_date" name="po_date" type="date" placeholder="Purchase Order Date" class="form-control round-input" />
                                    </div>

                                    <div class="col-lg-6">
                                        <label for="delivery_date" class="control-label text-danger">Delivery Date *</label>
                                        <input id="delivery_date" name="delivery_date" type="date" placeholder="Delivery Date" class="form-control round-input" />
                                    </div>
                                </div>
