...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Article Increment List Print | <?=WEBSITE_NAME;?></title>
    ...
    <body class="A4" id="page-content" >
        ...
        <!--</form>-->
       <div> <button id="downloadExcel" class="btn btn-success" style="display: block; margin: 40px auto 0px;">Download as Excel</button></div>
            ...
            <div>
                ...
                <div class="container">
                    <div class="row border_all text-center text-uppercase mar_bot_3">
                        <h3 class="mar_0 head_font">Article Wise Price List</h3>
                    </div>
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>FOB</th>
                                    <!--<th>Inc. Val.</th>-->
                                    <!--<th>Final Ex-Works</th>-->
                                    <!--<th>Final CIF</th>-->
                                    <!--<th>Final FOB</th>-->
                                </tr>
                            </thead>  
                            <tbody>
                                <?php $iter = 1;foreach($result as $res){ ?>
                                <tr>
                                    <td><?=$iter++?></td>
                                    <td><?=$res->art_no?></td>
                                    <td><?=$res->info?></td>
                                    <td><?=$res->exworks_amt?></td>
                                    <td><?=$res->cf_amt?></td>
                                    <td><?=$res->fob_amt?></td>
                                    <!--<td>< ?=$res->cost_increment?></td>-->
                                    <!--<td>< ?=$res->cost_increment + $res->exworks_amt?></td>-->
                                    <!--<td>< ?=$res->cost_increment + $res->cf_amt?></td>-->
                                    <!--<td>< ?=$res->cost_increment + $res->fob_amt?></td>-->
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
        ...
        document.getElementById('downloadExcel').addEventListener('click', function() {
            ...
            XLSX.writeFile(workbook, "Article Wise Price List.xlsx");
        });
        </script>
