...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Article Costing Print | <?=WEBSITE_NAME;?></title>
        ...
        <section class="sheet padding-10mm" style="height: auto;">
            <div>
                ...
                <div class="container">
                    ...
                    <div class="row mar_bot_3">
                        <p class="mar_0 border_all col-sm-6"><b>Customer:</b> <?= $costing[0]->customer_name ?></p>
                        <p class="mar_0 border_all col-sm-6"><b>Created on:</b> <?= date('d-m-Y', strtotime($costing[0]->create_date)) ?> 
                        | <b>Modified on:</b> <?= date("d-m-Y", strtotime('+12 hours +30 minutes', strtotime($costing[0]->modify_date))) ?></p>
                    </div>
                        ...
                        <table class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody class="actual_table">
                                        ...
                                        foreach ($costing as $cost_details) {
                                            // echo '<pre>', print_r($cost_details), '</pre>';die;
    ...
    <section class="sheet padding-10mm" style="height: auto;">
            ...
            <div>
                ...
                <div class="container">
                        ...
                        <table class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody class="actual_table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <span class="final_ex"><?php $ex = ($l_total+$commission) - ($fr + $fob) ?></span>
                                                <?=number_format((float)($ex), 2, '.', '')?>
                                            </td>
                                            <!--<td></td>-->
                                        </tr> 
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right final_cnf"><?= number_format((float)(($total_com + $ex + $fr)), 2, '.', '') ?></td>
                                            <!--<td></td>-->
                                        </tr>   
                                        <tr>
                                            <td colspan="5"><b>Total Cost Per Piece FOB</b></td>
                                            <td class="text-right final_fob"><?= number_format((float)($total_com + $ex + $fob), 2, '.', '') ?></td>
                                            <!--<td></td>-->
                                        </tr>   
                    ...
                    <div class="row">
                        <p class="mar_0 col-sm-4"></p>
                        <div class="mar_0 col-sm-4 border_all">
                            <div class="row">
                                <div class="col-sm-9"><p class="mar_0"><b>Cost Increment Value :</b></p></div>
                                <div class="col-sm-3 text-right"> <?= $costing[0]->cost_increment ?></div>
                                <hr>
                                <div class="col-sm-9"><p class="mar_0"><b>Final Ex-Works :</b></p></div>
                                <div class="col-sm-3 text-right"><?= number_format((float)($costing[0]->cost_increment + $ex), 2, '.', '') ?></div>
                                
                                <div class="col-sm-9"><p class="mar_0"><b>Final C&F :</b></p></div>
                                <div class="col-sm-3 text-right"> <?= number_format((float)($costing[0]->cost_increment + ($total_com + $ex + $fr)), 2, '.', '') ?></div>
                                
                                <div class="col-sm-9"><p class="mar_0"><b>Final FOB :</b></p></div>
                                <div class="col-sm-3 text-right"> <?= number_format((float)($costing[0]->cost_increment + $total_com + $ex + $fob), 2, '.', '') ?></div>
                            </div>
                        </div>
