                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                            <?php 
                                    ?>
                            <a href="<?= base_url('admin/overtime-add') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Overtime</a>
                                <?php
                            ?>
...
<script>
    $(document).ready(function() {
        $('#reveive_purchase_order_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-overtime-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
    ...
    $(document).on('click', '.delete', function(){
        ...
        if(confirm("Are You Sure?")){
            ...
            $.ajax({
                url: "<?= base_url('admin/del-overtime-list') ?>",
                dataType: 'json',
                type: 'POST',
                data: {id: $pk_id_value},
