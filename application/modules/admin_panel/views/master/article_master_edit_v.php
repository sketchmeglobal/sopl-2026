                        ...
                        <div class="panel-body">
                            <form id="form_edit_article" method="post" action="<?=base_url('admin/form_edit_article')?>" enctype="multipart/form-data" class="cmxform form-horizontal tasi-form">
                                ...
                                <div class="form-group ">
                                    ...
                                    <label for="remark" class="control-label col-lg-2">Remark/HSN Code</label>
                                    <div class="col-lg-4">
                                        <input id="remark" name="remark" type="text" value="<?=$article->remark?>" placeholder="Remark/HSN Code" class="form-control round-input" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        <input id="cutting_rate_a" name="cutting_rate_a" type="number" min="0.00" step="0.01" value="<?=$article->cutting_rate_a?>" placeholder="Cutting rate - A" class="form-control round-input" />
                                    </div>

                                    <label for="cutting_rate_b" class="control-label col-lg-2">Cutting Rate - B</label>
                                    <div class="col-lg-4">
                                        <input id="cutting_rate_b" name="cutting_rate_b" type="number" min="0.00" step="0.01" value="<?=$article->cutting_rate_b?>" placeholder="Cutting rate - B" class="form-control round-input" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        <input id="skiving_rate_a" name="skiving_rate_a" type="number" min="0" step="0.01" value="<?=$article->skiving_rate_a?>" placeholder="Skiving Sample Rate" class="form-control round-input" />
                                    </div>

                                    <label for="skiving_rate_b" class="control-label col-lg-2">Skiving Rate</label>
                                    <div class="col-lg-4">
                                        <input id="skiving_rate_b" name="skiving_rate_b" type="number" min="0" step="0.01" value="<?=$article->skiving_rate_b?>" placeholder="Skiving Rate" class="form-control round-input" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        <input id="fabrication_rate_a" name="fabrication_rate_a" type="number" min="0" step="0.01" value="<?=$article->fabrication_rate_a?>" placeholder="Fabrication rate - A" class="form-control round-input" />
                                    </div>

                                    <label for="fabrication_rate_b" class="control-label col-lg-2">Fabrication Rate - B</label>
                                    <div class="col-lg-4">
                                        <input id="fabrication_rate_b" name="fabrication_rate_b" type="number" min="0" step="0.01" value="<?=$article->fabrication_rate_b?>" placeholder="Fabrication rate - B" class="form-control round-input" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        <input id="wl_rate_a" name="wl_rate_a" type="number" min="0" step="0.001" value="<?=$article->wl_rate_a?>" placeholder="Weight - Leather code - A" class="form-control round-input" />
                                    </div>
                                ...
                                <div class="form-group ">
                                    <label for="no_of_part" class="control-label col-lg-2">Edge-inking Parts</label>
                                    <div class="col-lg-4">
                                    ...
                                    <label for="no_of_handle" class="control-label col-lg-2">Edge-inking Handle</label>
                                    <div class="col-lg-4">
                                ...
                                <div class="form-group ">
                                    ...
                                    <label for="splitting_part" class="control-label col-lg-2">Splitting Parts</label>
                                    <div class="col-lg-4">
                                        <input id="splitting_part" name="splitting_part" type="number" min="0" placeholder="Splitting Parts" class="form-control round-input" value="<?=$article->splitting_part?>" />
                                    </div>
