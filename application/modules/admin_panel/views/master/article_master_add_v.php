                        ...
                        <div class="panel-body">
                            <form id="form_add_article" method="post" action="<?=base_url('admin/form_add_article')?>" enctype="multipart/form-data" class="cmxform form-horizontal tasi-form">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        <input id="wl_rate_a" name="wl_rate_a" type="number" min="0" step="0.001" placeholder="Weight" class="form-control round-input" />
                                    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        <input id="splitting_part" name="splitting_part" type="number" min="0" placeholder="Splitting Parts" class="form-control round-input" />
                                    </div>
