...
<html lang="en">
<head>
    <title>Article Master Pending Clones | <?=WEBSITE_NAME;?></title>
        ...
        <div class="page-head">
            ...
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    ...
                    <li class="active"> Article Master Pending Clones </li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <table id="article_master_table_pending_clone" class="table data-table dataTable">
                                <thead>
                                <tr>
                                    <th>Article Group</th>
                                    <th>Article No</th>
...
<script>
    $(document).ready(function() {
        $('#article_master_table_pending_clone').DataTable( {
            "stateSave": true,
            "processing": true,
            "language": {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('ajax_article_master_table_data_pending_clone')?>",
                "type": "POST",
                "dataType": "json",
            },
        ...
        if(confirm('Are you sure?')){
            ...
            $.ajax({
                ...
                success: function(returnData){
                    ...
                    // redraw all tables 
                    $('#article_master_table_pending_clone').DataTable().ajax.reload();
                },
                error: function(e,v){
                    console.log(e + v);
                }
