...
<html lang="en">
<head>
    <title>Material Issue List | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Material Issue</h3>
                        ...
                        <div class="panel-body">
                            <?php 
                                if($view_permission != 'block'){
                                    ?>
                            <a href="<?= base_url('admin/material-issue-add') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Material Issue</a>
                                <?php
                            } 
                            ?>
...
<script>
    $(document).ready(function() {
        $('#reveive_purchase_order_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('admin/ajax-material-issue-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
            //will get these values from JSON 'data' variable
            "columns": [
                { "data": "issue_slip_number" },
                { "data": "issue_date" },
                { "data": "challan_or_supplier" },
                { "data": "issue_to_form" },
            ...
            "columnDefs": [{
                "targets": [1, 3, 5], //disable 'Image','Actions' column sorting
                "orderable": false,
            }]
        } );
    } );
    ...
    $(document).on('click', '.delete', function(){
        if(confirm('Are you sure?')){
            ...
            $.ajax({
                url: "<?= base_url('admin/delete-stock-in-details') ?>",
                type: 'POST',
                dataType: 'json',
