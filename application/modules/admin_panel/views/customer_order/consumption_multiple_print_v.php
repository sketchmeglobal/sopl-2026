                    ...
                    <div class="row mar_bot_3">
                        ...
                        <div class="col-sm-6 header_right">
                            ...
                            <div class="row border_all height_63 mar_bot_3">
                                <div class="col-sm-12">
                                    <p class="mar_0">Buyer Ref. No. & Date: </p>
                                    <h5 class="mar_0"><strong><?= $consumption[0]->buyer_reference_no . ' dated, '. date('d-m-Y', strtotime($consumption[0]->co_reference_date)) ?></strong></h5>
                                    <h5 class="mar_0">Group: <strong><?=$consumption[0]->group_name?></strong></h5>
                                </div>
                            </div>
                            <div class="row border_all height_21">
                                <div class="col-sm-12">
                                    <p class="mar_0">Buyer: <?= $consumption[0]->name . ' ['. $consumption[0]->short_name .']' ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="" class="table table-bordered table-hover width-100 table2excel consumption_table" >
                                ...
                                <tbody>
                                    ...
                                    if(end($keys) == $curr_key) {
                                        ?>
                                        <tr>
                                            <th colspan="3">Total for <?=$con->item_name?>[<?= $con->leather_color ?>]</th>
