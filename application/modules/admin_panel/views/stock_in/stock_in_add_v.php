...
<html lang="en">
<head>
    <title>Add Stock In | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Add Stock In</h3>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                            <form id="form_add_receive_purchase_order" method="post" action="<?=base_url('admin/form_add_stock_in')?>" class="cmxform form-horizontal tasi-form">
                            	<div class="form-group ">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input id="purchase_order_receive_date" name="purchase_order_receive_date" type="date" placeholder="Purchase Receive Date" class="form-control round-input" />
                                    </div>                                    
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <label for="plating_id_add" class="control-label">Select Plating</label>
                                        <select id="plating_id_add" name="plating_id_add" class="form-control select2">
                                        <option value="">Select Plating</option>
                                                <?php
                                                foreach($plating_details as $pd){
                                                ?> 
                                                    <option value="<?= $pd->platting_issue_id ?>"><?= $pd->platting_issue_number ?></option>
                                                    <?php
                                                }
                                                ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <button class="btn btn-success pull-right" type="submit"><i class="fa fa-plus"> Add Stock In</i></button>
                                    </div>
                                    <div class="col-lg-6">
                                        <a id="edit_btn" href="javascript:void(0)" class="hidden btn btn-info"><i class="fa fa-pencil"> Edit Stock In</i></a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    $('#form_add_receive_purchase_order').ajaxForm({
        ...
        success: function (returnData) {
			...
			if(obj.insert_id > 0){
				...
				window.location.href = '<?=base_url()?>admin/edit-stock-in/'+obj.insert_id;
