            ...
            <div>
                ...
                <div class="container">
                    <div class="row border_all text-center text-uppercase mar_bot_3">
                        <h3 class="mar_0 head_font">Splitting Bill</h3>
                    </div>
                        ...
                        <div class="col-sm-6 header_right">
                            <div class="row mar_bot_3">
                                <div class="col-sm-12 border_all height_60">
                                    <div class="">
                                        ...
                                        <h5 class="mar_0"><strong><?= $splitting_bill_details[0]->bill_number ?><br /> dated, <?= $splitting_bill_details[0]->bill_date ?></strong></h5>
                                    </div>
                                </div>
                            ...
                            <div class="row border_all height_63 mar_bot_3">
                                <div class="col-sm-12">
                                    ...
                                    <h4><b><?= $splitting_bill_details[0]->name ?></b></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <table id="" class="table table-bordered table-hover width-100 table2excel consumption_table" >
                                ...
                                $iter=1;
                                $skv_total = 0;
                                foreach($splitting_bill_details as $sbd){
                                ?>
                                    <tr>
                                        <td><?=$iter++?></td>
                                        <!-- <td>< ?=$sbd->bill_number . ' ('.$sbd->bill_date.')'?></td> -->
                                        <td nowrap><?=$sbd->co_no?></td>
                                        <!--<td nowrap>< ?=$sbd->splitting_issue_number?></td>-->
                                        <td><?=$sbd->art_no?></td>
                                        <td><?=$sbd->color?></td>
                                        <td style="text-align: right"><?=$sbd->splitting_paid_qnty?></td>
                                        <td style="text-align: right"><?=number_format($sbd->splitting_rate, 2)?></td>
                                        <td style="text-align: right"><?=number_format($sbd->splitting_part, 2)?></td>
                                        <td style="text-align: right"><?php echo number_format($sbd->splitting_amount, 2) ; $skv_total+=$sbd->splitting_amount?></td>
                                    </tr>
                                <?php    
                                } 
                                ?>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: right"><?=number_format($skv_total, 2)?></th>
                                </tr>
                            </table>
                        </div>
                    </div>
