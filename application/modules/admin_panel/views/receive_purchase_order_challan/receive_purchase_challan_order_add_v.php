...
<html lang="en">
<head>
    <title>Add Receive Purchase Challan Order | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Add Receive Purchase Challan Order</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Add Receive Purchase Challan Order</li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
...
?>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <button class="btn btn-success pull-right" type="submit"><i class="fa fa-plus"> Add Receive Purchase Challan Order</i></button>
                                    </div>
                                    <div class="col-lg-6">
