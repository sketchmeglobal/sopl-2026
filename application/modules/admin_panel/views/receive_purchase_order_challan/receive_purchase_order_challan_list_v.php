...
<html lang="en">
<head>
    <title>Material Challan Receipt List | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Material Challan Receipt</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Material Challan Receipt List</li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
                        ...
                        <div class="panel-body">
                            <?php 
                                if($view_permission != 'block'){
                                    ?>
                            <a href="<?= base_url('admin/add-receive-purchase-challan-order') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Material Challan Receipt</a>
                                <?php
                            } 
                            ?>
    ...
    $(document).ready(function() {
        ...
        $("#pur_rcv_id_id").change(function(){
            ...
            $('#reveive_purchase_order_table').DataTable( {
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?=base_url('admin/ajax-receive-purchase-order-challan-table-data')?>",
