...
<head>
    <meta charset="UTF-8">
    <title>Salary Portal | Login | <?=WEBSITE_NAME;?></title>
...
<div class="wrapper">
    <div class="container">
        ...
        <form class="form" action="<?=base_url('salary_portal');?>" method="post">
            <input type="text" name="username" placeholder="Username / Email" required="">
            <input type="password" name="pass" placeholder="Password" required="">
            <button type="submit" name="submit" value="salary_portal_login">Log Me In <i class="fa fa-sign-in"></i></button>
        </form>
