...
?></b></td>
                ...
                if($wordArray[2] < 4 || $wordArray[2] == 12) {
                  ...
                  $date2 = strtotime('2024-' . $mn . '-01');  
                }
                if($wordArray[2] < 4 || $wordArray[2] == 12) {
                $date_prev = strtotime('2024-' . '01' . '-01');     
                } else if($wordArray[2] == 1) {
                $date_prev = strtotime('2024-' . $mn_prev . '-01');
                }else {
                $date_prev = strtotime('2024-' . $mn_prev . '-01');    
                }
                $stepVal = '+1 month';
...
?>
                ...
                $current_sal = strtotime('2024-04-01');
                $dates_sal = array();
                $dates1_sal = array();
                //$date2 = strtotime('2023-03-01');
                ...
                if($array_sal[2] < 4 || $array_sal[2] == 12) {
                  ...
                  $date2_sal = strtotime('2024-' . $mn . '-01');  
                }
