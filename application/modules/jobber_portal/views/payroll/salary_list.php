        ...
        <div class="page-head">
            ...
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('salary_portal/dashboard');?>">Home</a></li>
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                         ...
                         <div class="panel-body">
                            ...
                            <form action="<?= base_url('salary_portal/payroll-emp-salary-add') ?>" method="post" target="_blank">
...
<script>
            $(document).ready(function () {
                $attr = "<?= base_url('salary_portal/payroll-emp-salary-add') ?>";
                $('a.add_button').attr('href', $attr);
                $('a.add_button').attr('target', '_blank');
            });
