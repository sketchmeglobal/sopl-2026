            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                               ...
                               <select name="month" id="month" class="form-control">
                                   ...
                                   ?>
                                    <option <?= (date('F') == date('F', mktime(0, 0, 0, $mon, 1))) ? 'selected' : '' ?>><?= date('F', mktime(0, 0, 0, $mon, 1)) .'~'. cal_days_in_month(CAL_GREGORIAN,$mon,date('Y'))  .'~'. $mon ?></option>
                                   <?php
                                   }
                                   ?>
                               </select>
           ...
           $(document).ready(function(){
               ...
               $('#group').change(function(){
                   ...
                   $.ajax({
                       method: 'post',
                       dataType: 'json',
                       url: "<?= base_url('salary_portal/emp-on-dept-id') ?>",
                       data: {gr_id:$gr_id},
