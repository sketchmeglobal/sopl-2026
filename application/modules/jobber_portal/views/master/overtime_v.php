...
<html lang="en">
<head>
    <title>Overtime List | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Overtime List</h3>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                            <?php 
                                    ?>
                            <a href="<?= base_url('accounts/overtime-add') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Overtime</a>
                                <?php
                            ?>
...
<script>
    $(document).ready(function() {
        $('#reveive_purchase_order_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('accounts/ajax-overtime-table-data')?>",
                "type": "POST",
                "dataType": "json",
            },
    ...
    $(document).on('click', '.delete', function(){
        ...
        if(confirm("Are You Sure?")){
            $pk_id_value = $(this).attr('pk-value');

            $.ajax({
                url: "<?= base_url('accounts/del-overtime-list') ?>",
                dataType: 'json',
                type: 'POST',
                data: {id: $pk_id_value},
