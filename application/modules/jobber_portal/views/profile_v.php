                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="basic_info_form" method="post"
                                      action="<?= base_url(); ?>accounts/form_basic_info">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form id="change_pass_form" method="post" action="<?=base_url();?>salary_portal/form_change_pass">
                                <div>
                                    <h3>Step 1</h3>
                                    <section>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="change_email_form" method="post" action="<?=base_url();?>accounts/form_change_email">
                                    <div class="form-group ">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="change_username_form" method="post" action="<?=base_url();?>accounts/form_change_username">
                                    <div class="form-group ">
